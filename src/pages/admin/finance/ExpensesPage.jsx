    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-text-secondary mt-1">Track school expenses</p>
        </div>
      </div>
      <div className="bg-white rounded-xl border border-border shadow-card p-16 text-center">
        ...
        <h3 className="text-lg font-semibold text-text-primary mb-2">Expenses — Coming in Phase 3+</h3>
