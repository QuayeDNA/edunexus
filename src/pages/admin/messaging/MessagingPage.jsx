  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-text-primary">Messaging</h1>
          <p className="text-sm text-text-secondary mt-1">Send messages to students, parents, and staff</p>
        </div>
      </div>
      <div className="bg-white rounded-xl border border-border shadow-card p-16 text-center">
        ...
        <h3 className="text-lg font-semibold text-text-primary mb-2">Messaging — Coming in Phase 3+</h3>
