...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 h-full z-40 flex flex-col bg-white border-r border-border transition-all duration-300 no-print',
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-20 w-6 h-6 rounded-full bg-white border border-border shadow-sm flex items-center justify-center hover:bg-surface-hover transition-colors z-50"
