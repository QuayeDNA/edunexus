...
export default function Header() {
  const { setSidebarOpen, sidebarOpen, toggleNotificationsPanel } = useUiStore();
      ...
      <div className="flex-1 max-w-sm hidden md:block">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm border border-transparent rounded-lg bg-surface-muted focus:outline-none focus:ring-2 focus:ring-brand-500 focus:bg-white focus:border-brand-300 placeholder:text-text-muted transition-all"
          />
        </div>
      </div>
