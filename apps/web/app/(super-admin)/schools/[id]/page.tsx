...
export default function SchoolDetailPage({
  ...
  return (
    <div>
      <PageHeader
        title={data.name}
        description={`Code: ${data.code} | Slug: ${data.slug}`}
      >
        <Button onClick={() => router.push(`/schools/${id}/edit`)}>
          Edit School
        </Button>
      </PageHeader>
      ...
      <Tabs defaultValue="overview">
            ...
            <CardContent className="pt-6">
              <dl className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <dd className="font-medium">{data.curriculum}</dd>
                </div>
                <div>
                  <dt className="text-sm text-muted-foreground">Calendar</dt>
                  <dd className="font-medium">{data.calendar}</dd>
                </div>
                <div>
        ...
        <TabsContent value="users" className="mt-4">
          <p className="text-sm text-muted-foreground">
            Users will be listed here after Phase 3.
          </p>
        </TabsContent>
        <TabsContent value="subscriptions" className="mt-4">
          <p className="text-sm text-muted-foreground">
            Subscriptions will be managed once billing is active.
          </p>
        </TabsContent>
      </Tabs>
    </div>
