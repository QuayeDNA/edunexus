...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 32px; color: #1a1a2e;">
  <div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="padding: 24px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
      ...
      <p style="font-size: 16px; line-height: 1.5;">Thank you for submitting an application for <strong>${studentName}</strong>.</p>
      <p style="font-size: 16px; line-height: 1.5;">Your application has been received and is now under review. You will be notified once a decision has been made.</p>
