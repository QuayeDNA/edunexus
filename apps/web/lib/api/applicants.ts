import type { ApplicantListItem, ApplicantStats, ApplicantClassOption, ConversionResult } from '@/types/applicant';
...
export async function fetchApplicants(params: ApplicantListParams): Promise<ApplicantListResponse> {
