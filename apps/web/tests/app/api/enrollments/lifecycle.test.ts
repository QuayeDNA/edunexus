...
describe("POST /api/enrollments/[id]/transfer", () => {
  ...
  it("returns 200 with certificate URL on successful transfer", async () => {
    ...
    mockUpload.mockResolvedValue({
      url: "/api/files/serve/transfer-certificates/e1.pdf",
      path: "transfer-certificates/e1.pdf",
    ...
    expect(body.data.transferCertificateUrl).toBe(
      "/api/files/serve/transfer-certificates/e1.pdf",
    );
  });
