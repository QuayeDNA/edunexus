...
vi.mock('@/lib/db', () => {
  const mockStudents = [
    {
      id: 's1', firstName: 'John', lastName: 'Doe', otherNames: null,
      studentIdNumber: 'STU001', gender: 'male', status: 'active',
      enrollmentDate: '2024-09-01', className: 'Class 1A',
      gradeLevelName: 'Grade 1', guardianName: 'Jane Doe',
    },
    {
      id: 's2', firstName: 'Jane', lastName: 'Smith', otherNames: null,
      studentIdNumber: 'STU002', gender: 'female', status: 'active',
      enrollmentDate: '2024-09-01', className: 'Class 1B',
      gradeLevelName: 'Grade 1', guardianName: 'John Smith',
    },
  ];
...
describe('GET /api/students', () => {
  ...
  it('returns paginated student list', async () => {
    ...
    expect(body.meta).toEqual({ page: 1, pageSize: 10, total: 5, totalPages: 1 });
  });
  ...
  it('requires admin role', async () => {
    ...
    (auth as any).mockResolvedValueOnce({
      user: { id: 'u2', role: 'student', schoolId, email: 's@b.com', name: 'S' },
    });
