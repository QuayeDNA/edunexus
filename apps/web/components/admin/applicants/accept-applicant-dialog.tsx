        ...
        {!result ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Select a class to place the student in and convert the
                applicant.
              </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={!selectedClassId || acceptMutation.isPending}
              >
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Applicant has been converted to a student. Share the credentials
                below.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="rounded-lg border bg-muted/30 p-4 space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  ID: {result.student.studentIdNumber}
                </p>
              </div>
              ...
              {result.credentials.student.email && (
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 space-y-2">
                  ...
                  <p className="text-sm text-amber-700">
                    Email: {result.credentials.student.email}
                  </p>
                  <p className="text-sm text-amber-700">
                    Password:{" "}
              ...
              {result.credentials.parent.email && (
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 space-y-2">
                  ...
                  <p className="text-sm text-amber-700">
                    Email: {result.credentials.parent.email}
                  </p>
                  <p className="text-sm text-amber-700">
                    Password:{" "}
                    <code className="bg-amber-100 px-1 rounded">
                      {result.credentials.parent.password}
                    </code>
                  </p>
                </div>
              )}
