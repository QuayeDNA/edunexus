import {
  pgTable, uuid, text, timestamp, varchar, integer, boolean, time, index,
...
export const vehicles = pgTable('vehicles', {
  ...
  index('idx_vehicles_school_id').on(table.schoolId),
]);
...
export const routes = pgTable('routes', {
  ...
  index('idx_routes_school_id').on(table.schoolId),
]);
