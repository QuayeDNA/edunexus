...
export const payrollRuns = pgTable(
  ...
  (table) => [
    ...
    index("idx_payroll_runs_month_year").on(
      table.schoolId,
      table.month,
      table.year,
    ),
...
export const payslips = pgTable(
  "payslips",
  {
    ...
    deductions: numeric("deductions", { precision: 12, scale: 2 })
      .default("0")
      .notNull(),
    ssnitEmployee: numeric("ssnit_employee", { precision: 12, scale: 2 })
      .default("0")
      .notNull(),
    ssnitEmployer: numeric("ssnit_employer", { precision: 12, scale: 2 })
      .default("0")
      .notNull(),
    payeTax: numeric("paye_tax", { precision: 12, scale: 2 })
      .default("0")
      .notNull(),
