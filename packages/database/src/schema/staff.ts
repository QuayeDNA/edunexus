import {
  pgTable, uuid, text, timestamp, varchar, date, index, uniqueIndex,
...
export const staff = pgTable('staff', {
  ...
  employmentStatus: varchar('employment_status', { length: 20 }).default('permanent').notNull(),
  ...
  uniqueIndex('idx_staff_school_id_number').on(table.schoolId, table.staffIdNumber),
